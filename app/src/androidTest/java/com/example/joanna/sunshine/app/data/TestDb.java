 ...
 */
package com.example.joanna.sunshine.app.data;
...
public class TestDb extends AndroidTestCase {
    ...
    void deleteTheDatabase() {
        mContext.deleteDatabase(com.example.joanna.sunshine.app.data.WeatherDbHelper.DATABASE_NAME);
    }
    ...
    */
    public void testLocationTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Incorrect values returned", cursor, testValues);
